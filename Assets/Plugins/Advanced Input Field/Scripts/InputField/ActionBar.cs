...
namespace AdvancedInputFieldPlugin
{
	...
	public class ActionBar: MonoBehaviour
	{
		...
		public void Initialize(AdvancedInputField inputField, MobileTextInputHandler textInputHandler)
		{
		...
		{
			actionBarRenderer.gameObject.SetActive(true);
		}
		...
		public void UpdateSize(float canvasScaleFactor)
		{
