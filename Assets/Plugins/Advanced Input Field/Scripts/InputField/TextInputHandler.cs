...
namespace AdvancedInputFieldPlugin
{
	...
	public abstract class TextInputHandler
	{
		...
		public virtual void Initialize(AdvancedInputField inputField, TextNavigator textNavigator, TextManipulator textManipulator)
		{
		...
		/// <param name="position">The position of th event</param>
		public virtual void OnDoubleTap(Vector2 position)
		{
		...
		/// <param name="position">The position of th event</param>
		public virtual void OnHold(Vector2 position)
		{
		}
